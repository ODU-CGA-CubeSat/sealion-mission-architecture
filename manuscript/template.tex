...
\abstract{The SeaLion flight architecture team for the SeaLion CubeSat project used a model based system engineering with docs-as-code approach to improve planning and organization of the project.  This was done in response to the growing number of University CubeSat teams with untrained students and personnel.  The team created tools for the systems architecture with the Mach 30 Modeling Language to create a architecture that is easy to learn and use even for newly admitted team members with little to no training. These tools can also generate documents via its own code for easy presentaton on a local file system without any proprietary software.}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/cubesat_family.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/cubesat_blownup.png}
...
\begin{figure}[H]
    \includegraphics{Definitions/impedence.png}
...
\begin{figure}[H]
    \includegraphics{Definitions/spectral.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/decs.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/launch_data.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/mission_status.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/user_story.png}
...
\begin{figure}[H]
    \includegraphics{Definitions/folders.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/reference.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/reference_file.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/stakeholder.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/stakeholder_file.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/uml_stakeholder.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/userstory_file.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/view_beacon.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/uml_userstory.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/uml_userstory2.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/datastructure.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/datastructure_file.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/uml_datastructure.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/components_file.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/components.png}
...
\begin{figure}[H]
    \includegraphics[width=10.5 cm]{Definitions/N2.png}
...
\acknowledgments{Special thanks to Dr. Sharan Asundi, PhD., Sean Marquez, and the SeaLion Project Team}
