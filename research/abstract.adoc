...
An example data structure can be derived from user stories.
...
Using a docs-as-code approach to flight software a means of tight coupling between both software and documentation,
as well as providing a highly structured template to base future developments on for the CubeSat community.
